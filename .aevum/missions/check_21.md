...
## Steps for Agent
1. Sử dụng `mcp_github_get_pull_request_status`, `mcp_github_get_issue` hoặc `mcp_github_get_pull_request_reviews` với Issue/PR number là `21` để xem tiến trình review.
